...
/**
 * Created by qi on 2016/2/29.
 */
public class Mytiezi extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    private ListView listView;
    private SimpleAdapter simpleAdapter = null;
    private SwipeRefreshLayout swipeRefreshLayout;
    private List<Map<String,Object>> list;
    private Getmytz getmytz;
    private int s=0;
    private int f=20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.mytiezitoolbar);
        ...
        swipeRefreshLayout = (SwipeRefreshLayout)findViewById(R.id.mytiezisrl);
        swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
        swipeRefreshLayout.setOnRefreshListener(this);

        listView = (ListView)findViewById(R.id.mytzlistView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Mytiezi.this, Tiezi.class);
        ...
        intentFilter.addAction("action.refreshtz");
    ...
    public void onRefresh(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                list.addAll(getmytz.getmytz(acconut, s, f));
    ...
    public void getSimpleAdapter() {
        getmytz = new Getmytz();         //从数据库获取数据生成arraylist 对象
        SharedPreferences preferences = getSharedPreferences("itke", MODE_PRIVATE);
        final String acconut= preferences.getString("account",null).trim().toString();
        list = getmytz.getmytz(acconut, s, f);
    ...
    private BroadcastReceiver mRefreshBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("action.refreshtz"))
            {
                onRefresh();
            }
        }
